...
publication: "2024/02/20 12:00:00"
tags:
    - swiftnio
    - networking
authors:
...
In the previous tutorial, [SwiftNIO Channels](/using-swiftnio-channels/), you learned how to use SwiftNIO to build a simple TCP echo server. In this tutorial, you'll build a simple HTTP client using SwiftNIO.
