...
publication: "2024/02/08 12:00:00"
tags:
    - swiftnio
    - networking
    - server
...
In the previous tutorial, [SwiftNIO Fundamentals](/using-swiftnio-fundamentals/), you've learned the fundamentals of SwiftNIO. You're now familiar with the concept of an ``EventLoop``.
...
The samples make use of VSCode DevContainers ([Developing with Swift in Visual Studio Code](/developing-with-swift-in-visual-studio-code/) to provide a consistent development environment. If you're not using VSCode, you can also use the latest Xcode.
...
In the next tutorial, ([Building a SwiftNIO HTTP client](/building-swiftnio-clients/), we'll cover how to suppport a protocol (HTTP/1) by using Channel Handlers, by building an HTTP client.
