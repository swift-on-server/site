---
title: "Getting Started: Swift's Structured Concurrency"
...
publication: "2024/03/19 12:00:00"
tags:
...
To learn more about Async Sequences, visit [Advanced Async Sequences in Swift](/advanced-async-sequences/).
...
Almost every application that you write will also have some form of shared state. In the next article, [Sendable and Shared Mutable State](/structured-concurrency-and-shared-state-in-swift/), we'll cover how Swift's actors, actor isolation and Sendable checking empower you to write race-condition free code.
