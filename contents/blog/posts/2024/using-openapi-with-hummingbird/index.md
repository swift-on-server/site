...
publication: "2024/03/5 12:00:00"
tags:
    - documentation
    - hummingbird
    - openapi
...
In this tutorial, we'll show you how to use the OpenAPI Generator to create a Swift API with Hummingbird ([What’s new in Hummingbird 2?](/whats-new-in-hummingbird-2/)). If you're using Hummingbird with AWS Lambda, you can also use the OpenAPI generator for handling routes in your Lambda function.
